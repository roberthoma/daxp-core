...
public class Dax_AA_Preamble_Test_01 extends DaxTestConfig {
    ...
    void AA_shouldEncodeAndDecodePreamble() {
        ...
        DaxConfig config  = crmProvider.getConfig();
        ...
        preambleStr = preambleStr.replace(DaxConfig.PAIR_SEPARATOR,'|');

        assertEquals("DAXP="+ DaxConfig.PROTOCOL_VERSION +"|EN=UTF-8|CX=CRM|", preambleStr);
