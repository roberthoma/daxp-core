...
import org.daxprotocol.core.test.dax_02_use_case_tests.dax_010_00_annotation.DaxAnyManifest;
...
public class DaxAnySchemaRegister {
    ...
    @DaxpTag( description = "Other CTX Test TAG String" , daxDataType = DaxDataType.CHARACTER ) //, clazz = String.class)
    public static final String TEST_CTX_TAG_StrVal_FIX51 = CTX_FIX + DaxCoreConstants.NAMESPACE_TAG_SEPARATOR +  "51";

//    @DaxpTag( description = "Description from DaxpRegiststry", daxDataType = DaxDataType.STRING,clazz = DaxAnyTestEnum.class)
